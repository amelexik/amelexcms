<?php /* Smarty version Smarty-3.0.6, created on 2011-04-14 09:08:57
         compiled from "/home/web20/domains/autostok.com.ua/public_html/themes/autostok2/templates/registration_form.html" */ ?>
<?php /*%%SmartyHeaderCode:5099556984da68f79b2f1d5-78827927%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d99df171bf4191037679866b5b9df0e6f05b0d7' => 
    array (
      0 => '/home/web20/domains/autostok.com.ua/public_html/themes/autostok2/templates/registration_form.html',
      1 => 1302511819,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5099556984da68f79b2f1d5-78827927',
  'function' => 
  array (
  ),
...
?>
	...
	<table width="100%" cellspacing="8" border="0">
		<tr>
			<td width="1%"><label for="login"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_login'];?>
:*</label></td>
			<td><input type="text" name="login" id="login" value="<?php echo $_POST['login'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="name"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_name'];?>
:*</label></td>
			<td><input type="text" name="name" id="name" value="<?php echo $_POST['name'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="city"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_city'];?>
:</label></td>
			<td><input type="text" name="city" id="city" value="<?php echo $_POST['city'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="register_costumer_type"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_costumer_type'];?>
:*</label></td>
			<td>
		...
		<tr id="company_row_reg_table" style="display:">
			<td><label for="company"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_organization'];?>
:*</label></td>
...
" /></td>
		...
		<tr>
			<td><label for="phone_num"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_phone'];?>
:*</label></td>
			<td><input type="text" name="phone_num" id="phone_num" value="<?php echo $_POST['phone_num'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="email"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_email'];?>
:*</label></td>
			<td><input type="text" name="email" id="email" value="<?php echo $_POST['email'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="password"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_password'];?>
:*</label></td>
			<td><input type="password" name="password" id="password" value="<?php echo $_POST['password'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="password2"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_password2'];?>
:*</label></td>
			<td><input type="password" name="password2" id="password2" value="<?php echo $_POST['password2'];?>
" /></td>
		</tr>
		<tr>
			<td><label for="from_user">Откуда вы о нас узнали:*</label></td>
			<td>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['title'];?>
		...
		<tr>
			<td valign="middle"><label for="code"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['label_kcaptcha'];?>
:*</label></td>
			<td>
				<p>
					<div id="captcha">
		...
		<tr>
			...
			<td><button class="button" type="submit"><?php echo $_smarty_tpl->getVariable('app')->value->constants['reg_form']['page_header_reg'];?>
</button></td>
		</tr>
	</table>
	</form>
